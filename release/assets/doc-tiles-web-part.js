define("72b368fb-f784-4b6c-81ad-49ba9b768e08_0.0.1", ["react","react-dom","@microsoft/sp-webpart-base","@microsoft/sp-property-pane"], (__WEBPACK_EXTERNAL_MODULE__2650__, __WEBPACK_EXTERNAL_MODULE__2729__, __WEBPACK_EXTERNAL_MODULE__3134__, __WEBPACK_EXTERNAL_MODULE__4723__) => { return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
/******/ 	var __webpack_modules__ = ({

/***/ 1766:
/*!**************************************************************!*\
  !*** ./lib/webparts/docTiles/components/DocTiles.module.css ***!
  \**************************************************************/
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".host_51f82e1a{--deep-blue:#114461;--lightblue:#00aeef;--orange:#fb8c2e;--muted:#6a7a86;--ink:#0f2430;--shadow:0 6px 22px rgba(17,68,97,.12);--inner:0 1px 0 rgba(17,68,97,.06),0 10px 24px rgba(17,68,97,.08);--fs-12:12px;--fs-13:13px;--fs-14:14px;--fs-15:15px;--fs-16:16px;--fs-18:18px;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;color:var(--ink);font-family:Segoe UI Variable,Segoe UI,system-ui,-apple-system,BlinkMacSystemFont,Roboto,Helvetica,Arial,sans-serif;font-size:var(--fs-14);line-height:1.5;text-rendering:optimizeLegibility}.header_51f82e1a{align-items:center;display:flex;gap:12px;margin-bottom:10px}.header_51f82e1a h2{color:var(--deep-blue);font-family:Segoe UI Variable Display,Segoe UI,system-ui,sans-serif;font-size:20px;font-weight:600;letter-spacing:.3px;line-height:1.4;margin:0}.header_51f82e1a a{color:var(--lightblue);font-size:var(--fs-14);font-weight:700;margin-left:auto;text-decoration:none}.header_51f82e1a a:hover{text-decoration:underline}.status_51f82e1a{color:var(--muted);margin-bottom:12px}.grid_51f82e1a{display:grid;gap:18px;grid-template-columns:repeat(auto-fit,minmax(340px,1fr))}@media (max-width:480px){.grid_51f82e1a{grid-template-columns:1fr}}.card_51f82e1a{background:#fff;border-radius:20px;box-shadow:var(--shadow);display:flex;flex-direction:column;padding:0 16px 12px}.catbar_51f82e1a{align-items:center;background:var(--deep-blue);border-radius:14px;color:#fff;display:flex;font-family:Segoe UI Variable Display,Segoe UI,system-ui,sans-serif;gap:10px;margin:16px 0 14px;padding:8px 14px}.catname_51f82e1a{font-size:14px;font-weight:700;letter-spacing:.8px}.count_51f82e1a{font-size:13px;font-weight:600;margin-left:auto;opacity:.95}.doclist_51f82e1a{display:grid;gap:12px;grid-template-columns:1fr}.pill_51f82e1a{align-items:center;background:#fff;border:1px solid rgba(17,68,97,.16);border-radius:999px;box-shadow:var(--inner);color:var(--ink);display:flex;gap:12px;padding:12px 16px;text-decoration:none;transition:transform 60ms ease,box-shadow .12s ease,border-color .12s ease,background .12s ease}.title_51f82e1a{flex:1 1 auto;font-size:var(--fs-15);font-weight:600;letter-spacing:.1px}.clamp2_51f82e1a .title_51f82e1a{line-clamp:2;-webkit-line-clamp:2;-webkit-box-orient:vertical;display:-webkit-box;line-height:1.35em;max-height:2.7em;overflow:hidden;text-overflow:ellipsis}.dot_51f82e1a{background:var(--orange);border-radius:50%;flex:0 0 auto;height:12px;width:12px}.pill_51f82e1a:hover{background:#f7fbff;border-color:var(--lightblue);box-shadow:0 10px 26px rgba(17,68,97,.14);transform:translateY(-1px)}.pill_51f82e1a:focus{box-shadow:0 0 0 4px rgba(0,174,239,.45);outline:3px solid #fff;outline-offset:2px}.foot_51f82e1a{display:flex;justify-content:flex-end;margin-top:12px}.more_51f82e1a{color:var(--lightblue);font-size:var(--fs-14);font-weight:700;text-decoration:none}.more_51f82e1a:hover{text-decoration:underline}\n/*# sourceMappingURL=data:application/json;base64, */", true);
...
/***/ 5669:
/*!******************************************************!*\
  !*** ./lib/webparts/docTiles/components/DocTiles.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ DocTiles)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 2650);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DocTiles.module.scss */ 5872);
...
function DocTiles(props) {
    var _this = this;
    var sp = props.sp, title = props.title, listId = props.listId, groupField = props.groupField, viewUrl = props.viewUrl, maxPer = props.maxPer, showCounts = props.showCounts, twoLineClamp = props.twoLineClamp;
    var _a = react__WEBPACK_IMPORTED_MODULE_0__.useState(true), loading = _a[0], setLoading = _a[1];
    var _b = react__WEBPACK_IMPORTED_MODULE_0__.useState({}), groups = _b[0], setGroups = _b[1];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, sp.web.lists.getById(listId).items
                                .select("Id,Title,FileRef,FSObjType,".concat(groupField))
                                .filter('FSObjType eq 0')()];
                    case 2:
                        raw = _a.sent();
                        map_1 = {};
                        raw.forEach(function (r) {
                            var key = r[groupField] || 'Uncategorized';
                            (map_1[key] || (map_1[key] = [])).push({ Id: r.Id, Title: r.Title, FileRef: r.FileRef });
                        });
                        setGroups(map_1);
                        return [3 /*break*/, 5];
                    case 3:
                        e_1 = _a.sent();
                        console.error("DocTiles load error", e_1);
    ...
    var cats = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(function () { return Object.keys(groups).sort(function (a, b) { return a.localeCompare(b); }); }, [groups]);
    var catLink = function (cat) {
        return viewUrl ? "".concat(viewUrl, "?FilterField1=").concat(encodeURIComponent(groupField), "&FilterValue1=").concat(encodeURIComponent(cat)) : '#';
    };
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].host },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].header },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, title),
            viewUrl && react__WEBPACK_IMPORTED_MODULE_0__.createElement("a", { href: viewUrl, target: "_blank", rel: "noopener" }, "View all")),
        error && react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].status, style: { color: "#d83b01" } },
            "Failed to load: ",
            error),
        loading && !error && react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].status }, "Loading\u2026"),
        !loading && !error && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].grid },
            cats.map(function (cat) {
                var docs = groups[cat] || [];
                return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { key: cat, className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].card },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].catbar },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].catname }, cat),
                        showCounts && react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].count }, docs.length)),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].doclist }, docs.slice(0, maxPer).map(function (d) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("a", { key: d.Id, className: "".concat(_DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].pill, " ").concat(twoLineClamp ? _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].clamp2 : ''), href: d.FileRef, target: "_blank", rel: "noopener", "aria-label": "".concat(d.Title || d.FileRef, " (opens in new tab)") },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].dot }),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].title }, d.Title || (d.FileRef || '').split('/').pop()))); })),
                    (docs.length > maxPer && viewUrl) && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].foot },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("a", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].more, href: catLink(cat), target: "_blank", rel: "noopener" }, "More\u2026")))));
            }),
            cats.length === 0 && react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: _DocTiles_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].status }, "No documents found.")))));
}
...
/***/ 5872:
/*!******************************************************************!*\
  !*** ./lib/webparts/docTiles/components/DocTiles.module.scss.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* tslint:disable */
__webpack_require__(/*! ./DocTiles.module.css */ 1766);
var styles = {
    host: 'host_51f82e1a',
    header: 'header_51f82e1a',
    status: 'status_51f82e1a',
    grid: 'grid_51f82e1a',
    card: 'card_51f82e1a',
    catbar: 'catbar_51f82e1a',
    catname: 'catname_51f82e1a',
    count: 'count_51f82e1a',
    doclist: 'doclist_51f82e1a',
    pill: 'pill_51f82e1a',
    title: 'title_51f82e1a',
    clamp2: 'clamp2_51f82e1a',
    dot: 'dot_51f82e1a',
    foot: 'foot_51f82e1a',
    more: 'more_51f82e1a'
};
...
/* harmony export */ });
/* unused harmony exports _Fields, _Field, Field, FieldTypes, DateTimeFieldFormatType, DateTimeFieldFriendlyFormatType, AddFieldOptions, CalendarType, UrlFieldFormatType, FieldUserSelectionMode, ChoiceFieldFormatType */
...
/* harmony export */ });
/* unused harmony exports spGet, spPostDelete, spPostDeleteETag, spDelete, spPatch, InitialFieldQuery, ComparisonResult */
/* harmony import */ var _pnp_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @pnp/core */ 1971);
/* harmony import */ var _pnp_queryable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @pnp/queryable */ 6844);
...
(() => {
/*!**************************************************!*\
  !*** ./lib/webparts/docTiles/DocTilesWebPart.js ***!
  \**************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
...
/* harmony import */ var _pnp_sp_webs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @pnp/sp/webs */ 3867);
/* harmony import */ var _pnp_sp_lists__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @pnp/sp/lists */ 2033);
/* harmony import */ var _pnp_sp_fields__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @pnp/sp/fields */ 3032);
/* harmony import */ var _components_DocTiles__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/DocTiles */ 5669);
...
var DocTilesWebPart = /** @class */ (function (_super) {
    __extends(DocTilesWebPart, _super);
    function DocTilesWebPart() {
    ...
    DocTilesWebPart.prototype.onInit = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this._sp = (0,_pnp_sp__WEBPACK_IMPORTED_MODULE_4__.spfi)().using((0,_pnp_sp__WEBPACK_IMPORTED_MODULE_4__.SPFx)(this.context));
                        // Populate property pane options
                        return [4 /*yield*/, this._loadLists()];
                    case 2:
                        // Populate property pane options
                        _a.sent();
                        if (!this.properties.listId) return [3 /*break*/, 4];
                        return [4 /*yield*/, this._loadFields(this.properties.listId)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
                        // Defaults
                        if (this.properties.maxPerCategory === undefined)
                            this.properties.maxPerCategory = 6;
                        if (this.properties.title === undefined)
                            this.properties.title = "Document Hub";
                        if (this.properties.showCounts === undefined)
                            this.properties.showCounts = true;
                        if (this.properties.twoLineClamp === undefined)
                            this.properties.twoLineClamp = true;
                        return [2 /*return*/];
                }
            });
        });
    };
    DocTilesWebPart.prototype._loadLists = function () {
        return __awaiter(this, void 0, void 0, function () {
            var lists, visible, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        lists = _a.sent();
                        visible = lists.filter(function (l) {
                            return !l.Hidden && (l.BaseTemplate === 101 || l.BaseTemplate === 100);
                        } // 101=DocLib, 100=List
                        );
                        this._listOptions = visible.map(function (l) { return ({ key: l.Id, text: l.Title }); });
                        return [3 /*break*/, 5];
                    case 3:
                        e_1 = _a.sent();
                        console.error("List load error", e_1);
                        this._listOptions = [];
                        return [3 /*break*/, 5];
                    case 4:
    ...
    DocTilesWebPart.prototype._loadFields = function (listId) {
        return __awaiter(this, void 0, void 0, function () {
            var fields, allowed_1, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this._sp.web.lists.getById(listId).fields
                                .select("InternalName,Title,Hidden,ReadOnlyField,TypeAsString")()];
                    case 2:
                        fields = _a.sent();
                        allowed_1 = new Set(["Text", "Choice", "Lookup", "TaxonomyFieldType", "TaxonomyFieldTypeMulti"]);
                        this._fieldOptions = fields
                            .filter(function (f) { return !f.Hidden && !f.ReadOnlyField && allowed_1.has(f.TypeAsString); })
                            .map(function (f) { return ({ key: f.InternalName, text: "".concat(f.Title, " (").concat(f.InternalName, ")") }); });
                        return [3 /*break*/, 5];
                    case 3:
                        e_2 = _a.sent();
                        console.error("Field load error", e_2);
                        this._fieldOptions = [];
                        return [3 /*break*/, 5];
                    case 4:
    ...
    DocTilesWebPart.prototype.onPropertyPaneConfigurationStart = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._loadLists()];
                    case 1:
                        _a.sent();
    ...
    DocTilesWebPart.prototype.onPropertyPaneFieldChanged = function (propertyPath, oldValue, newValue) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(propertyPath === "listId" && newValue && newValue !== oldValue)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._loadFields(newValue)];
                    case 1:
                        _a.sent();
    ...
    DocTilesWebPart.prototype.render = function () {
        var element = react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_DocTiles__WEBPACK_IMPORTED_MODULE_8__["default"], {
            sp: this._sp,
    ...
    DocTilesWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [{
                    ...
                    groups: [{
                            groupName: "Basics",
                            groupFields: [
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneTextField)('title', { label: 'Title', placeholder: 'Document Hub' }),
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneDropdown)('listId', {
                                    label: 'List/Library',
                                    options: this._listOptions,
                                    selectedKey: this.properties.listId,
                                    disabled: this._listOptions.length === 0
                                }),
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneDropdown)('groupFieldInternalName', {
                                ...
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneTextField)('viewUrl', {
                                    label: 'View URL (for "View all" & "More…")',
                                    placeholder: '/sites/Dept/Library/Forms/AllItems.aspx'
                                }),
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneTextField)('maxPerCategory', {
                                    label: 'Max items per category',
                                    value: String(this.properties.maxPerCategory || 6)
                                }),
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneToggle)('showCounts', { label: 'Show counts in header', checked: this.properties.showCounts }),
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneToggle)('twoLineClamp', { label: 'Clamp file title to two lines', checked: this.properties.twoLineClamp })
                            ]
                        }]
                }]
        };
    };
    DocTilesWebPart.prototype.onDispose = function () {
        react_dom__WEBPACK_IMPORTED_MODULE_1__.unmountComponentAtNode(this.domElement);
    };
    return DocTilesWebPart;
}(_microsoft_sp_webpart_base__WEBPACK_IMPORTED_MODULE_2__.BaseClientSideWebPart));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DocTilesWebPart);
...
//# sourceMappingURL=doc-tiles-web-part.js.map